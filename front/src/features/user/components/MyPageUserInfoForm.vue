  ...
  <div class="w-full max-w-xl mx-auto space-y-6">
    <div>
      <div class="flex flex-wrap gap-4 mt-6">
        <h2 class="text-base text-auth-label-color">이름 설정</h2>
        <BaseInput
          v-model="nickname"
          type="text"
          placeholder="이름"
    ...
    <div>
      <div class="flex flex-wrap gap-4 mt-6">
        <div class="w-[100%]">
          <h2 class="text-base text-auth-label-color">건강 상태 메모</h2>
        </div>
        <KeywordTag
    ...
    <div>
      <div class="flex flex-wrap gap-2 mt-6">
        <div class="w-[100%]">
          <h2 class="text-base text-auth-label-color">관심 태그</h2>
        </div>
        <KeywordTag
    ...
    <!-- 알림 설정 -->
    <div class="space-y-2">
      <h2 class="text-base text-auth-label-color">내 하루 설정</h2>
