...
import static com.rouby.user.user.domain.entity.NotificationType.ROUTINE;
import static com.rouby.user.user.domain.entity.NotificationType.SCHEDULE;
...
import com.rouby.user.user.presentation.dto.request.UpdateRoubySettingRequest.NotificationSettingRequest;
