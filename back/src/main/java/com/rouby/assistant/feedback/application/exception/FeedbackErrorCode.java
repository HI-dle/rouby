...
public enum FeedbackErrorCode implements ErrorCode {
  ...
  EXCEEDED_DAILY_USAGE("피드백의 당일 사용량을 모두 초과하였습니다.", "EXCEEDED_DAILY_USAGE", HttpStatus.TOO_MANY_REQUESTS),
  CONCURRENT_REQUEST_FAILED("너무 빠른 시간 내에 피드백을 동시 요청할 수 없습니다.", "CONCURRENT_REQUEST_FAILED", HttpStatus.TOO_MANY_REQUESTS),;
