...
import static com.rouby.user.user.domain.entity.OnboardingState.COMPLETED;
import static com.rouby.user.user.domain.entity.OnboardingState.ROUBY_SETTING_BEFORE;
...
public class User extends BaseEntity {
  ...
  private void validateRoubySettingRequirement() {
    if (communicationTone.isEmpty()) {
      throw new IllegalStateException("루비 말투는 비어있을 수 없습니다.");
    }
  }
