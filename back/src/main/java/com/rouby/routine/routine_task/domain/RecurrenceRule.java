...
import com.rouby.routine.routine_task.domain.entity.ByDaySetRoutineConverter;
import com.rouby.routine.routine_task.domain.enums.Freq;
import com.rouby.routine.routine_task.domain.enums.Weekday;
import com.rouby.routine.routine_task.domain.support.UntilDateTimeFormatter;
...
public class RecurrenceRule implements Serializable {
  ...
  @Convert(converter = ByDaySetRoutineConverter.class)
  private Set<Weekday> byDay;
  ...
  @Builder
  private RecurrenceRule(Freq freq, Set<Weekday> byDay, Integer interval, LocalDateTime until) {
    this.freq = freq;
    this.byDay = byDay;
