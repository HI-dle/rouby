...
include::{snippets}/refresh-token-200/http-request.adoc[]

==== 요청 필드

include::{snippets}/refresh-token-200/request-fields.adoc[]

==== HTTP 응답 (200 OK)

include::{snippets}/refresh-token-200/http-response.adoc[]
